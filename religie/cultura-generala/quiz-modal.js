...
function openQuizModal(type, question, options, correctIndex, explanation, mediaUrl, videoId) {
  ...
  newAnswerBtn.addEventListener('click', function () {
    ...
    if (optionsContainer.style.display !== 'block') {
      ...
      resultMessage.textContent = `Răspunsul corect este: ${options[correctIndex - 1]}`;
    ...
    if (selectedOption) {
      ...
      resultMessage.textContent = 'Vă rugăm să selectați mai întâi o variantă de răspuns!';
      resultMessage.classList.add('incorrect');
      resultMessage.style.display = 'block';
